...
class PaperTrade(TimestampMixin, Base):
    ...
    one_contract_fee_estimate: Mapped[Decimal | None] = mapped_column(Numeric(10, 6))
    total_fee_estimate: Mapped[Decimal | None] = mapped_column(Numeric(14, 6))
    settlement_audit_key: Mapped[str | None] = mapped_column(String(220))
    settlement_formula_version: Mapped[str | None] = mapped_column(String(120))
    settlement_formula: Mapped[str | None] = mapped_column(Text)
    settlement_source: Mapped[str | None] = mapped_column(String(80))
    settlement_source_game_id: Mapped[str | None] = mapped_column(String(120))
    settlement_source_market_ticker: Mapped[str | None] = mapped_column(String(120))
    settlement_checked_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    settlement_resolved_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    settlement_status: Mapped[str | None] = mapped_column(String(80))
    settlement_outcome: Mapped[str | None] = mapped_column(String(40))
    settlement_skip_reason: Mapped[str | None] = mapped_column(String(160))
    settlement_error_reason: Mapped[str | None] = mapped_column(String(160))
    settlement_idempotency_key: Mapped[str | None] = mapped_column(String(220))
    settlement_payout: Mapped[Decimal | None] = mapped_column(Numeric(14, 2))
    settlement_fee_adjustment: Mapped[Decimal | None] = mapped_column(Numeric(14, 2))
