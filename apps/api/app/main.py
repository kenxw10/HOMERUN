            ...
            session.execute(
                ...
                .options(
                    ...
                    load_only(
                        ...
                        ModelCandidate.probability_hardening_policy_version,
                        ModelCandidate.probability_hardening_enabled,
                        ModelCandidate.probability_raw_adapter,
                        ModelCandidate.probability_before_hardening,
                        ModelCandidate.probability_after_hardening,
                        ModelCandidate.probability_hardening_delta,
                        ModelCandidate.probability_hardening_applied,
                        ModelCandidate.probability_hardening_reason,
                        ModelCandidate.probability_hardening_status,
                        ModelCandidate.probability_hardening_line_class,
                        ModelCandidate.probability_hardening_line_class_policy,
                        ModelCandidate.probability_hardening_consistency_status,
                        ModelCandidate.probability_hardening_monotonicity_status,
                        ModelCandidate.probability_hardening_ladder_role,
                        ModelCandidate.probability_hardening_ladder_size,
                        ModelCandidate.probability_hardening_ladder_rank,
                        ModelCandidate.probability_hardening_distance_from_central,
                        ModelCandidate.probability_hardening_central_reference_line,
                        ModelCandidate.probability_hardening_central_reference_probability,
                        ModelCandidate.probability_hardening_dampening_factor,
...
def _candidate_prediction_probability_hardening(candidate: ModelCandidate | None) -> dict[str, object]:
    if candidate is None:
        return {
            "probability_hardening_policy_version": None,
            "probability_hardening_enabled": None,
            "probability_raw_adapter": None,
            "probability_before_hardening": None,
            "probability_after_hardening": None,
            "probability_hardening_delta": None,
            "probability_hardening_applied": None,
            "probability_hardening_reason": None,
            "probability_hardening_status": None,
            "probability_hardening_line_class": None,
            "probability_hardening_line_class_policy": None,
            "probability_hardening_consistency_status": None,
            "probability_hardening_monotonicity_status": None,
            "probability_hardening_ladder_role": None,
            "probability_hardening_ladder_size": None,
            "probability_hardening_ladder_rank": None,
            "probability_hardening_distance_from_central": None,
            "probability_hardening_central_reference_line": None,
            "probability_hardening_central_reference_probability": None,
            "probability_hardening_dampening_factor": None,
            "probability_hardening_shadow_only": None,
            "probability_hardening_block_recommendation": None,
            "probability_hardening_error_reason": None,
        }
    return {
