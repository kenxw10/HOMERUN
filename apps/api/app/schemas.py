...
class PositionSummary(BaseModel):
    ...
    settlement_source_game_id: str | None = None
    settlement_source_market_ticker: str | None = None
    settlement_checked_at: str | None = None
    settlement_resolved_at: str | None = None
    settlement_status: str | None = None
    settlement_outcome: str | None = None
    settlement_skip_reason: str | None = None
    settlement_error_reason: str | None = None
    settlement_idempotency_key: str | None = None
    settlement_payout: float | None = None
    settlement_fee_adjustment: float | None = None
...
class DashboardSummary(BaseModel):
    ...
    settled_profit_loss: float | None = None
    unrealized_profit_loss: float | None = None
    fees_paid: float | None = None
    fees_estimated_open: float | None = None
    open_cost: float | None = None
    open_mark_value: float | None = None
    open_trade_count: int = 0
    settled_trade_count: int = 0
    drawdown_policy_version: str | None = None
    drawdown_observation_mode: bool | None = None
    drawdown_basis: str | None = None
    drawdown_halt_enforced: bool | None = None
    drawdown_would_have_halted: bool | None = None
    drawdown_live_halt_threshold_abs: float | None = None
    drawdown_live_halt_basis: str | None = None
    drawdown_starting_bankroll: float | None = None
    drawdown_halt_level: float | None = None
